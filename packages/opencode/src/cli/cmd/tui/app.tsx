  ...
  command.register(() => [
    ...
    },
    {
      ...
      onSelect: (dialog) => {
        ...
        const visible = current === "show" || (current === "auto" && kv.get("sidebar_open", false))
        const next = current === "auto" ? (visible ? "hide" : "show") : current === "show" ? "hide" : "show"
        kv.set("sidebar", next)
        kv.set("sidebar_open", next === "show")
        dialog.clear()
      },
    },
  ])
