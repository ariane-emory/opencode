...
import { BoxRenderable, ScrollBoxRenderable, addDefaultParsers, MacOSScrollAccel, type ScrollAcceleration, TextAttributes, RGBA, StyledText, SyntaxStyle } from "@opentui/core"
...
export function Session() {
  ...
  createEffect(async () => {
    ...
    await sdk.client.session
      ...
      .then(() => sync.session.sync(sessionID))
      .then(() => {
