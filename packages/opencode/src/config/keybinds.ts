...
const KeybindsSchema = Schema.StructWithRest(
  Schema.Struct({
    ...
    input_lowercase_word: keybind("alt+l", "Lowercase word in input"),
    input_uppercase_word: keybind("alt+u", "Uppercase word in input"),
    input_capitalize_word: keybind("alt+c", "Capitalize word in input"),
    input_yank: keybind("ctrl+y", "Yank (paste) last killed text"),
    input_transpose_characters: keybind("none", "Transpose characters in input"),
