...
export function substituteArguments(
  ...
  // Find all placeholders ($N, ${...}, ${N:default}, ${N..M:default})
  ...
  // Process default placeholders ${N:default}
  ...
  // Process extended placeholders ${...} - no swallowing
  ...
  // Process simple $N placeholders - no swallowing
