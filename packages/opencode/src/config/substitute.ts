...
export function substituteArguments(
  ...
  let withArgs = template

  // Process range with defaults first (most specific: has both .. and :)
  withArgs = withArgs.replaceAll(rangeWithDefaultRegex, (expr, start, dotsAndEnd, defaultVal) => {
  ...
  // Process extended placeholders ${...} with .. but no :
