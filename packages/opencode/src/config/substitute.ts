...
// Matches: ${N:default}, ${N:$1:default} (chained fallbacks)
// Group 1: position, Group 2: default value (can include $N references)
const defaultPlaceholderRegex = /\$\{(\d+):([^}]*)\}/g

// Matches: ${N..M:default}, ${..M:default}, ${N..:default}, ${..:default} (range with default)
// Group 1: start (optional), Group 2: dots+end, Group 3: default value
...
export function substituteArguments(
  ...
  // Process range with defaults first (most specific: ${N..M:default})
  ...
  // Process simple defaults: ${N:default}
  ...
  // Process extended placeholders without defaults: ${N}, ${N..M}, ${..M}, ${N..}, ${..}
