...
import customizeOpencodeSkillFile from "../../../core/src/plugin/skill/customize-opencode.md" with { type: "file" }
const CUSTOMIZE_OPENCODE_SKILL_BODY = await Bun.file(customizeOpencodeSkillFile).text()
