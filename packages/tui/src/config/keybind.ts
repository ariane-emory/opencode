...
export const Definitions = {
  ...
  session_bookmark: keybind("ctrl+b", "Bookmark session"),
  ...
  session_continue: keybind("none", "Continue interrupted conversation"),
  ...
  input_newline: keybind("shift+return,ctrl+return,alt+return,ctrl+j,linefeed", "Insert newline in input"),
...
export const CommandMap = {
  ...
  session_child_toggle: "session.child.toggle",
